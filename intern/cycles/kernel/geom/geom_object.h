...
ccl_device_inline float object_volume_density(__device_space KernelGlobals *kg, int object)
{
  if (object == OBJECT_NONE) {
    return 1.0f;
  }
...
ccl_device_inline float object_volume_step_size(__device_space KernelGlobals *kg, int object)
{
  if (object == OBJECT_NONE) {
