...
ccl_device void svm_node_fresnel(
    __thread_space ShaderData *sd, __thread_space float *stack, uint ior_offset, uint ior_value, uint node)
{
...
ccl_device void svm_node_layer_weight(__thread_space ShaderData *sd, __thread_space float *stack, uint4 node)
{
