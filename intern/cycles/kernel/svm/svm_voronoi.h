...
ccl_device void voronoi_f1_1d(float w,
                              ...
                              float randomness,
                              NodeVoronoiDistanceMetric metric,
                              __thread_space float *outDistance,
                              __thread_space float3 *outColor,
                              __thread_space float *outW)
{
...
ccl_device void voronoi_distance_to_edge_1d(float w, float randomness, __thread_space float *outDistance)
{
  float cellPosition = floorf(w);
  float localPosition = w - cellPosition;
...
ccl_device void voronoi_n_sphere_radius_1d(float w, float randomness, __thread_space float *outRadius)
{
  float cellPosition = floorf(w);
  float localPosition = w - cellPosition;
...
ccl_device void voronoi_f1_2d(float2 coord,
                              ...
                              __thread_space float *outDistance,
                              __thread_space float3 *outColor,
                              __thread_space float2 *outPosition)
{
...
ccl_device void voronoi_distance_to_edge_2d(float2 coord, float randomness, __thread_space float *outDistance)
{
  float2 cellPosition = floor(coord);
  float2 localPosition = coord - cellPosition;
...
ccl_device void voronoi_n_sphere_radius_2d(float2 coord, float randomness, __thread_space float *outRadius)
{
  float2 cellPosition = floor(coord);
  float2 localPosition = coord - cellPosition;
...
ccl_device void voronoi_f1_3d(float3 coord,
                              ...
                              __thread_space float *outDistance,
                              __thread_space float3 *outColor,
                              __thread_space float3 *outPosition)
{
...
ccl_device void voronoi_distance_to_edge_3d(float3 coord, float randomness, __thread_space float *outDistance)
{
  float3 cellPosition = floor(coord);
  float3 localPosition = coord - cellPosition;
...
ccl_device void voronoi_n_sphere_radius_3d(float3 coord, float randomness, __thread_space float *outRadius)
{
  float3 cellPosition = floor(coord);
  float3 localPosition = coord - cellPosition;
...
ccl_device void voronoi_f1_4d(float4 coord,
                              ...
                              __thread_space float *outDistance,
                              __thread_space float3 *outColor,
                              __thread_space float4 *outPosition)
{
...
ccl_device void voronoi_distance_to_edge_4d(float4 coord, float randomness, __thread_space float *outDistance)
{
  float4 cellPosition = floor(coord);
  float4 localPosition = coord - cellPosition;
...
ccl_device void voronoi_n_sphere_radius_4d(float4 coord, float randomness, __thread_space float *outRadius)
{
  float4 cellPosition = floor(coord);
  float4 localPosition = coord - cellPosition;
...
ccl_device void svm_node_tex_voronoi(__device_space KernelGlobals *kg,
