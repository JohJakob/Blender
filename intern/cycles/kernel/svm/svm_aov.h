...
ccl_device_inline bool svm_node_aov_check(__thread_space ccl_addr_space PathState *state,
...
ccl_device void svm_node_aov_color(
    __device_space KernelGlobals *kg, __device_space ShaderData *sd, __thread_space float *stack, uint4 node, ccl_global __device_space float *buffer)
{
