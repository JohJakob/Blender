...
ccl_device_inline void path_state_modify_bounce(__device_space ccl_addr_space PathState *state, bool increase)
{
...
ccl_device_inline void path_state_branch(__device_space ccl_addr_space PathState *state,
                                         int branch,
                                         int num_branches)
{
  if (num_branches > 1) {
